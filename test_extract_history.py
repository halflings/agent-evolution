...
test_parse_antigravity_transcript = test_extract_history_lib.test_parse_antigravity_transcript
test_discover_antigravity_prefers_transcript_over_full = (
    test_extract_history_lib.test_discover_antigravity_prefers_transcript_over_full
)
